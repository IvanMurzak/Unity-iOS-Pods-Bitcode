...
using com.github.ivanmurzak.ios.pods.bitcode.Installer.SimpleJSON;

namespace com.github.ivanmurzak.ios.pods.bitcode.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.github.ivanmurzak.ios.pods.bitcode.Installer.Tests/test_manifest.json";
        const string PackageId = "com.github.ivanmurzak.ios.pods.bitcode";
